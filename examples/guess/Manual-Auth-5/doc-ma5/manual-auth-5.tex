...
%\resizebox{0.55\textwidth}{!}
{
  ...
  \begin{msc}{}
   ...
   \nextlevel[-1]
      ...
      \mess{$m_1 = k$}{A}{B}
      \nextlevel[1,4]
      \mess{$m_2 = \shash(d_A,k,r)\qquad\qquad\qquad$}{A}{H}
      \nextlevel[1,4]
      \mess{$m_2 = \shash(d_A,k,r)\qquad\qquad\qquad$}{H}{B}
      \nextlevel[1,5]
      \action*{check $m_2 \stackrel{?}{=} \shash(d_B,m_1,r)$}{B}
      \action*{check $m_2 \stackrel{?}{=} \shash(d_B,k,r)$}{A}
      \nextlevel[1,5]
