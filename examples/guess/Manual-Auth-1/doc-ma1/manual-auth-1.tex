...
%\resizebox{0.55\textwidth}{!}
  ...
  \begin{msc}{}
      ...
      \nextlevel[1]
       \action*{new weak $k$}{A}
      \nextlevel[1,5]
      \mess{\qquad\qquad\qquad\qquad$m = (k, \shash(k, d_A))$}{A}{B}
      \nextlevel[2]
       \action*{check $snd(m) \stackrel{?}{=} \shash(fst(m), d_B)$}{B}
      \nextlevel[1,5]
      \nextlevel[1,5]
    ...
    \caption{Manual authentication mechanism 1}
    \label{fig:mec-1}
\end{figure}
...
\multirow{2}{*}{one session} & Auth. A & 51 & $<$ 4s & ok  \\ 
& Auth. B & 12 & $<$ 1s & ok  \\  \hline
\multirow{2}{*}{without start} & Auth. A & 70/111 & $<$ 5s & attack  \\ 
& Auth. B & 28/75 & $<$ 2s & attack  \\  \hline
without start & Auth. A & 111 & $<$ 1s & ok \\ 
+ h strong & Auth. B & 75 & $<$ 1s & ok \\  \hline
%\multirow{2}{*}{two sessions B in par.} & Auth. A & & & attack  \\ 
%& Auth. B & & & attack  \\  \hline
\multirow{2}{*}{two sessions} & Auth. A & 50133 & 2h30min & ok \\ 
& Auth. B & 2636 & 2m10s & ok \\  \hline
\end{tabular}
\end{center}
