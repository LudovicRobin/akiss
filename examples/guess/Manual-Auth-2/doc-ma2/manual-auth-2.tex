...
\nextlevel[-1]
      ...
      \nextlevel[1,4]
      \mess{$m_A= (k, \shash(k,d_A))$}{A}{H}
      \mess{$m_B= (k, \shash(k,d_B))$}{B}{H}
      \nextlevel[0,5]
       \action*{check $m_A \stackrel{?}{=} m_B$}{H}
      \nextlevel[1,4]
      \nextlevel[1,4]
    ...
    \caption{Manual authentication mechanism 2}
\end{figure}
...
\multirow{2}{*}{one session} & Auth. A & 368 & $<$ 8s & ok  \\ 
& Auth. B & 168 & $<$ 4s & ok  \\  \hline
\multirow{2}{*}{without start} & Auth. A & 360/592 & $<$ 8s & attack  \\ 
& Auth. B & 337/736 & $<$ 8s & attack  \\  \hline
without start & Auth. A & 592 & $<$ 4s & attack  \\ 
+ h strong & Auth. B & 736 & $<$ 5s & attack  \\  \hline
%\multirow{2}{*}{two sessions B in par.} & Auth. A & & & attack  \\ 
%& Auth. B & & & attack  \\  \hline
\multirow{2}{*}{two sessions} & Auth. A & 48852 & 59m & ok  \\ 
& Auth. B & 10794 & 8m30s & ok  \\  \hline
\end{tabular}
\end{center}
