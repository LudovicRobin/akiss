...
%\resizebox{0.55\textwidth}{!}
{
  ...
  \begin{msc}{}
   ...
   \nextlevel[-1]
      ...
      \mess{start}{H}{A}
      \nextlevel[1,4]
      \mess{$m_A = \hash(A,d_A,k_A,r)$}{A}{B}
      \nextlevel[1,4]
      \mess{$m_B = \hash(B,d_B,k_B,r)$}{B}{A}
      \nextlevel[1,4]
      \mess{$k_A$}{A}{B}
      \nextlevel[1,5]
      \action*{check $m_A \stackrel{?}{=} \hash(A,d_B,k_A,r)$}{B}
      \nextlevel[3]
      \mess{accept/reject}{B}{H}
      \nextlevel[1,4]
      \mess{$k_B$}{B}{A}
      \nextlevel[1,5]
      \action*{check $m_B \stackrel{?}{=} \hash(B,d_A,k_B,r)$}{A}
      \nextlevel[3]
    ...
    \caption{Manual authentication mechanism 7a}
\end{figure}
...
\multirow{2}{*}{one session} & Auth. A & 36078 & $<$ 15min & ok \\ 
& Auth. B & 38374 & $<$ 15min & ok \\  \hline
