...
%\resizebox{0.55\textwidth}{!}
{
  ...
  \begin{msc}{}
   ...
   \nextlevel[-1]
      ...
      \mess{start}{H}{A}
      \nextlevel[1,4]
      \mess{$m_{A1} = \hash(A,d_A,k_{A1},r_1)$}{A}{B}
      \nextlevel[1,4]
      \mess{$m_{B1} = \hash(B,d_B,k_{B1},r_1)$}{B}{A}
      \nextlevel[1,4]
      \mess{$k_{A1}$}{A}{B}
      \nextlevel[1,5]
      \action*{check $m_A \stackrel{?}{=} \hash(A,d_B,k_{A1},r_1)$}{B}
      \nextlevel[3]
      \mess{$k_{B1}$}{B}{A}
      \nextlevel[1,5]
      \action*{check $m_B \stackrel{?}{=} \hash(B,d_A,k_{B1},r_1)$}{A}
      \nextlevel[3]
      \mess{$m_A = \hash(A,d_A,k_{A2},r_2)$}{A}{B}
      \nextlevel[1,4]
      \mess{$m_B = \hash(B,d_B,k_{B2},r_2)$}{B}{A}
      \nextlevel[1,4]
      \mess{$k_{A2}$}{A}{B}
      \nextlevel[1,5]
      \action*{check $m_A \stackrel{?}{=} \hash(A,d_B,k_{A2},r_2)$}{B}
      \nextlevel[3]
      \mess{accept/reject}{B}{H}
      \nextlevel[1,4]
      \mess{$k_{B2}$}{B}{A}
      \nextlevel[1,5]
      \action*{check $m_B \stackrel{?}{=} \hash(B,d_A,k_{B2},r_2)$}{A}
      \nextlevel[3]
    ...
    \caption{Manual authentication mechanism 7b}
\end{figure}
